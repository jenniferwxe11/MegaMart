...
DIRTY_PLAN = {
    ...
    "competitor_price_history_raw.csv": "dirty_competitor_price_history",
    "store_catalogues_raw.csv": "dirty_store_catalogues",
    "product_content_quality_raw.csv": "dirty_product_content_quality",
    "stock_snapshots_raw.csv": "dirty_stock_snapshots",
    "inventory_change_events_raw.csv": "dirty_inventory_change_events",
    ...
    "bundle_items_raw.csv": "dirty_bundle_items",
    ...
    "product_reviews_raw.csv": "dirty_product_reviews",
}
